...
const missionDetails = [
  {
    ...
    icon: "https://betaspedire.b-cdn.net/imgs/perk-3.svg",
  },
  {
    description: "Free damage and theft protection up to €49!",
    icon: "https://betaspedire.b-cdn.net/imgs/perk-2.svg",
  },
  {
    description: "Over 40,000 shipping points to choose from",
    icon: "https://betaspedire.b-cdn.net/imgs/perk-1.svg",
  },
] as const;
interface Props {
  token: string;
      ...
      <section className="w-full flex items-center flex-col justify-center relative">
        ...
        <div className=" flex items-center justify-center flex-col gap-12 pt-28 lg:pt-48  w-full">
          <div className="space-y-5 text-center text-white">
            ...
            <div className="outline py-1 mx-6 outline-white/50 rounded-lg text-base font-semibold border border-white">
              <p>
                You abandoned a shipment you were creating:
                <Link href={"#"} className="underline">do you want to recover it </Link> or
                <Link href={"#"} className="underline">delete it?</Link>
              </p>
            </div>
          </div>
