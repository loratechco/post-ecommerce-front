    ...
    >
      <DialogContent className="max-sm:max-w-sm sm:max-w-lg rounded-lg space-y-2">
        <DialogHeader>
          ...
          <DialogDescription>
            By selecting any of the users, you can add them to the desired
            group.
          </DialogDescription>
        </DialogHeader>
        ...
        <FormProvider {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3">
            ...
            {!loading ? (
              ...
              <ul className="w-full *:w-full *:rounded-lg *:bg-zinc-200 *:h-11 space-y-2 *:animate-pulse">
                <li></li>
                <li></li>
                <li></li>
                <li></li>
